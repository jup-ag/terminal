...
export default function App({ Component, pageProps }: AppProps) {
  ...
  return (
    <div className="bg-jupiter-dark-bg h-screen w-screen overflow-auto">
      <AppHeader />
        ...
        <div className="flex flex-col items-center h-full w-full mt-4 md:mt-14">
          ...
          <div className="space-x-2 p-1.5 mt-12 bg-black/30 rounded-xl">
            ...
            <JupButton
              ...
              type="button"
              className={
                tab === "integrated" ? "bg-white/10" : "opacity-20 hover:opacity-70"
              }
            >
              <div className="flex items-center space-x-2 text-xs">
          ...
          <div className='w-full max-w-2xl px-2 md:px-0 text-white/75 mt-9 mb-16'>
